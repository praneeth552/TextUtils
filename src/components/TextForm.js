    ...
    return (
        <>
            <div className='container' style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                <button className='btn btn-primary mx-1' onClick={handleFupClick}>Convert to captilize</button>
                <button className='btn btn-primary mx-1' onClick={handleInClick}>Convert to inverse case</button>
